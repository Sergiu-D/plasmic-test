...
import sty from "./PlasmicPersonCard.module.css"; // plasmic-import: ItKVUfSkOclq/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__sYwYt)}
      >
        <h1
        ...
        <div className={classNames(projectcss.all, sty.freeBox__jvFe4)}>
          {renderPlasmicSlot({
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__czGnB)}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                ...
                >
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__q0Gl1)}
                ...
                >
                  <Icon2Icon
                    className={classNames(projectcss.all, sty.svg__y7EsR)}
                    role={"img"}
                  />
                </PlasmicLink__>
                <PlasmicLink__
                ...
                >
                  <Icon3Icon
                    className={classNames(projectcss.all, sty.svg__jfzKe)}
                    role={"img"}
                  />
                </PlasmicLink__>
              </React.Fragment>

...
import BlueBdr from "../../BlueBdr"; // plasmic-import: BBeltRLt0kLU/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic.module.css"; // plasmic-import: juVZkpy6GyNsQ7cQcnMtYR/projectcss
import sty from "./PlasmicServiceWhite.module.css"; // plasmic-import: mnA1CLTURO1Q/css
...
function PlasmicServiceWhite__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__mk3R2)}>
        {renderPlasmicSlot({
          defaultContents: (
            <BlueBdr
              className={classNames("__wab_instance", sty.blueBdr___4Ui1U)}
            />
          ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox___7TVIa)}>
        {renderPlasmicSlot({
          defaultContents:

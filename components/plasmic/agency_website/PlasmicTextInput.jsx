...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 7APLLFjPEFPA/css
import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: XOhSW-SUP7p_/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__mcUh)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___5466S)}
              role={"img"}
            />
          ),
